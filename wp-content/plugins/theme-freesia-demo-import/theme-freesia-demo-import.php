...
if ( is_plugin_active( 'zon-plus/zon-plus.php' ) ) {  // This is done because, zon plugin code is loaded after theme freesia demo import code
    $zon_plus = '1';
} else {
	$zon_plus ='';
}
...
if ($arise_plus || $freesiaempire_plus || $edge_plus || $pixgraphy_plus || $event_plus || $excellent_plus || $idyllic_plus || $storexmas_plus || $magbook_plus || $photograph_plus || $extension_plus || $shoppingcart_plus || $cocktail_plus || $eventsia_plus || $supermarket_plus || $zon_plus) {
	...
	}   elseif ($theme->Name == 'Zon'){

		require_once plugin_dir_path( __FILE__ ) .'plus-files/zon-plus.php';
	...
	require_once plugin_dir_path( __FILE__ ) .'files/photograph.php';
		...
		require_once plugin_dir_path( __FILE__ ) .'files/zon.php';
